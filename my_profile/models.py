...
class UserProfile(models.Model):
    ...
    Fields:
        ...
        profile_picture (CloudinaryField): Cloudinary image field for the user's profile picture.
...
def create_user_profile(sender, instance, created, **kwargs):
    """
    Signal handler to automatically create a user profile when a new user is created.

    Args:
        sender: The model class that sends the signal (User in this case).
        instance: The actual instance being saved.
        created (bool): True if a new instance was created, False if it was an update.
